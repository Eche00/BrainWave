  ...
  return (
    <div className=" border-t-[1px] border-[#E8ECEF] w-full">
      ...
      <main className=" w-full">
        {/* each section  */}
        <section className=" py-[64px]  flex justify-between flex-col md:flex-row gap-[20px] sm:gap-0">
          {/* 1  */}
        ...
        <section className=" py-[64px]  flex justify-between flex-col md:flex-row gap-[20px] sm:gap-0">
          ...
          <motion.div
            ...
            <div className=" relative   overflow-hidden md:w-fit w-full rounded-[24px] border-none">
              ...
              {/* updaate  */}
              <section className="absolute lg:w-[90%] md:w-[90%] sm:w-[90%] w-[90%] left-[5%]  bottom-0 flex flex-col  sm:px-[60px] px-[32px] sm:pt-[60px] pt-[32px] sm:gap-[24px] gap-[13px] rounded-t-[18px] bg-[#FEFEFE] dark:bg-[#141718] shadow-xl shadow-b-none dark:shadow-none">
                <span className=" absolute right-10 top-10">
                  {updateicons.exit}
                </span>
                <div>
        ...
        <div className="w-full flex items-center justify-center">
          <button className=" px-[24px] py-[12px] text-[16px] font-[600] leading-[24px] rounded-[12px] text-[#141718] border-[#E8ECEF] dark:border-[#343839] dark:text-white border-[2px] cursor-pointer">
            Load more
          </button>
        </div>
      </main>
